<template>
  <div id="map-chart">
      <div id="container" style="width:100%;height:500px;margin-left:30px"></div>
  </div>
</template>
  ...
  export default {
    ...
    methods: {
        aaa(){
            ...
            let heatmapOverlay,points = this.points
        ...
        setGradient(){
            ...
            _this.heatmapOverlay.setOptions({"gradient":gradient});
